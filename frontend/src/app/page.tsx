      ...
      <section id="pricing" className="py-32 px-6 max-w-7xl mx-auto relative">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative z-10">
          ...
          <div className="bg-neutral-900 border border-neutral-800 rounded-3xl p-8 flex flex-col hover:border-neutral-700 transition-colors">
            ...
            <Link href="/studio" className="w-full text-center bg-neutral-800 hover:bg-neutral-700 text-white font-semibold py-3.5 rounded-xl transition-colors">
              Get Started
            </Link>
          </div>
          ...
          <div className="bg-gradient-to-b from-indigo-900/50 to-neutral-900 border border-indigo-500/50 rounded-3xl p-8 flex flex-col relative transform md:-translate-y-4 shadow-2xl shadow-indigo-900/50">
            ...
            <Link href="/studio" className="w-full text-center bg-indigo-500 hover:bg-indigo-400 text-white font-semibold py-3.5 rounded-xl shadow-lg transition-colors">
              Start Pro Trial
            </Link>
          </div>
          ...
          <div className="bg-neutral-900 border border-neutral-800 rounded-3xl p-8 flex flex-col hover:border-neutral-700 transition-colors">
            ...
            <Link href="/studio" className="w-full text-center bg-white hover:bg-neutral-200 text-neutral-900 font-semibold py-3.5 rounded-xl transition-colors flex items-center justify-center gap-2">
